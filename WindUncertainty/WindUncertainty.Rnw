...
\date{\textcolor{red}{DRAFT} 1/20/2015}
...
% \include{ComponentsOfWindSensingSystem}
% 
% \include{SchulerSection}
% 
% \include{SensitivityCoefficients}
% 
% \include{VerticalWindStudies}
% 
% \include{HorizontalWindStudies}
% 
% \include{ElementsOfUncertaintyAndSummary}
