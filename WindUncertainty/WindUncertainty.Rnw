...
<<A, child='IntroductionN.Rnw'>>=
<<B, child='ComponentsOfWindSensingSystemN.Rnw'>>=
<<C, child='CalibrationProceduresN.Rnw'>>=
<<G, child='ElementsOfUncertaintyAndSummaryN.Rnw'>>=
#<<C, child='SchulerSection.Rnw'>>=
<<D, child='SensitivityCoefficientsN.Rnw'>>=
<<E, child='VerticalWindStudiesN.Rnw'>>=
<<F, child='HorizontalWindStudiesN.Rnw'>>=
@

\appendix

<<H, child='ConventionsN.Rnw'>>=
<<I, child='TurbulenceN.Rnw'>>=
@
...
\attachm{\Sexpr{thisFileName}.Rnw\\\Sexpr{thisFileName}.pdf\\chunks/*\\SessionInfo\\Ranadu\_2.1-15-3-8.tar.gz}
