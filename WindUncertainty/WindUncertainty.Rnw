...
system (sprintf("zip %s.zip %s.Rnw SessionInfo Introduction.Rnw ComponentsOfWindSensingSystem.Rnw Conventions.Rnw CalibrationProcedures.Rnw ElementsOfUncertaintyAndSummary.Rnw SensitivityCoefficients.Rnw SchulerSection.Rnw VerticalWindStudies.Rnw HorizontalWindStudies.Rnw Turbulence.Rnw ./chunks ./chunks/* ~/RStudio/Ranadu/Ranadu_2.1-15-5-29.tar.gz", thisFileName, thisFileName))
