...
\attachm{\Sexpr{thisFileName}.Rnw\\\Sexpr{thisFileName}.pdf\\chunks/*\\SessionInfo\\Ranadu\_2.1-15-5-29.tar.gz}
...
system (sprintf("zip %s.zip %s.Rnw %s.pdf SessionInfo ~/RStudio/Ranadu/Ranadu_2.1-15-5-29.tar.gz", thisFileName, thisFileName, thisFileName))
