...
\Sexpr{format(round(sqrt(SQ1d),2), nsmall=2)}\,m/s  &
...
ggplot(data=DataC, aes(WIC-WI_GP)) + geom_histogram(aes(y=..density..), binwidth=0.04, fill=I("lightyellow"), col=I("black"))+xlab("WIC-WI_GP [m/s]") + xlim(-2.,2.)+geom_density (col='red')+theme_WAC()
