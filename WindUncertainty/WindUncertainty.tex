...
\includegraphics[width=12.1cm]{GustPod1-r.png}\includegraphics[height=5.1cm]{GustPod2x-r}\\  \textsl{Photograph of the Gust Pod (bottom left) and the ports on the Rosemount 858 probe (right).} \index{gust pod!photograph} 
\par\end{center}
...
\begin{figure}%
\noindent \begin{centering}%
\includegraphics[width=0.9\columnwidth]{amt-2014-0031-f01.png}%
