...
Research (NCAR). This aircraft is referred to here as the NSF/NCAR GV or
simply the GV.
...
report. We also present additional information resulting from various
...
measurements, with a tabulation of individual error sources and
references to later parts of the document where studies reported
here have led to estimates of limits on those error sources. It is
...
in this report that has led to the conclusions summarized there.

Section \ref{sec:Calibrations} summarizes
...
the vertical wind, and includes a correction procedure that can
improve the measurement of pitch and hence the vertical wind.
The section discussing horizontal wind uses circle maneuvers
...
Kalman filter to improve the measurements, as noted in 
...
the pitch-correction procedure of Sect.~\ref{sec:Schuler}. In that section,
...
The correction technique of Sect.~\ref{sec:Schuler} is not
...
pitch-correction algorithm of Sect.~\ref{sec:Schuler}, Eq.~\ref{eq:pitch-error-wo-approx}, the bias estimate is 0.05\,m\,s$^{-1}$ and the net uncertainty is 0.06\,m/s.}\tabularnewline
\midrule 
